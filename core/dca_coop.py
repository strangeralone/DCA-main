...
class DCACoOpTrainer(DCATrainer):
    ...
    def __init__(self, config):
        ...
        self.coop_threshold_std = coop_config.get('threshold_std', 1.0)
    ...
    def _write_config_to_log(self, log_file, task_type, source_idx, target_idx=None):
        ...
        log_file.write(f"  coop.threshold_std: {self.coop_threshold_std}\n")
    ...
    def train_target(self, source_idx, target_idx, log_file=None):
        ...
        while iter_num < max_iter:
            ...
            # CoOp 蒸馏损失（使用可学习的提示生成文本特征）
            threshold = variance1.mean() + variance1.std() * self.coop_threshold_std
